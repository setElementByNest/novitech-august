...
export const VaccineAdd = ({ changePage }: Props) => {
    ...
    const [nowSelect3, setNowSelect3] = useState<string>('');

    const [nowList, setNowList] = useState<VaccineListItem[]>([]);
    ...
    const listPeriod = [
        { label: 'ทุก 1 เดือน', value: '1month' },
        { label: 'ทุก 2 เดือน', value: '2month' },
        { label: 'ทุก 3 เดือน', value: '3month' },
        { label: 'ทุก 4 เดือน', value: '4month' },
        { label: 'ทุก 5 เดือน', value: '5month' },
        { label: 'ทุก 6 เดือน', value: '6month' },
        { label: 'ทุก 1 ปี', value: '1year' },
    ]
    const listValue = [
        { label: '0.5 โดส', value: '0.5d' },
        { label: '1 โดส', value: '1d' },
        { label: '1.5 โดส', value: '1.5d' },
        { label: '2 โดส', value: '2d' },
        { label: '2.5 โดส', value: '2.5d' },
        { label: '3 โดส', value: '3d' },
        { label: '4.5 โดส', value: '4.5d' },
        { label: '5 โดส', value: '5d' },
        { label: '10 ml', value: '10ml' },
        { label: '20 ml', value: '20ml' },
        { label: '30 ml', value: '30ml' },
        { label: '40 ml', value: '40ml' },
